...
- Actions - information that sends data to the store. They are plain javascript objects that must have a type property to indicate what type of action is being preformed. They decide what happened but don't descritbe how the state changes this is done in reducers.

- Reducers - show how the apps state changes in response to the actions called upon it

- Store the store brings the actions and reducers together.
